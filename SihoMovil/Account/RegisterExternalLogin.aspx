<%@ Page Language="C#" Title="Registrar un inicio de sesión externo" MasterPageFile="~/SiteFrm.Master" AutoEventWireup="true" CodeBehind="RegisterExternalLogin.aspx.cs" Inherits="SihoMovil.Account.RegisterExternalLogin" %>
